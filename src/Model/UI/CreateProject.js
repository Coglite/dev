		...
		return (
				<div>
					...
					<div className="card example-card" style={{width: "20rem"}}>
					  <img width="100" className="card-img-top previewImage" src="assets/images/PortableBoxAlpha3.png" alt="previewImage"/>
					...
					<div className="card example-card" style={{width: "20rem"}}>
					  <img width="100" className="card-img-top previewImage" src="assets/images/minst_example.png" alt="previewImage"/>
					  <div className="card-body card-body-h">
					...
					<div className="card example-card" style={{width: "20rem"}}>
					  <img width="100" className="card-img-top previewImage" src="assets/images/ae_example.png" alt="previewImage"/>
					  <div className="card-body card-body-h">
