...
import { AccountBalanceWallet, Cloud, Dashboard, HelpOutline, Settings, SwapHoriz, DeviceHub } from '@material-ui/icons';
...
<Paper className={P.invert ? P.classes.leftNavInvert : P.classes.leftNav} >
              ...
              <DrawerItem route="/pages/flowgraph" icon={<DeviceHub />} />
