...
import '../../style/less/website.less';
...
@injectSheet(styles)
@observer
export class DesignerScreen extends React.Component<DesignerScreenProps, {}> {
    ...
    setMode(yamlMode: boolean) {
        this.designerState.setMode(yamlMode);
    }

    runDirtyFileCheck (): boolean {
