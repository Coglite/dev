...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(module) {\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.Constants = void 0;\n\nvar _electron = __webpack_require__(/*! electron */ \"electron\");\n\nvar mkdirp = __webpack_require__(/*! mkdirp */ \"mkdirp\");\n\nvar net = __webpack_require__(/*! net */ \"net\");\n\nvar path = __webpack_require__(/*! path */ \"path\");\n\nvar _os = __webpack_require__(/*! os */ \"os\");\n\n(function () {\n  var enterModule = __webpack_require__(/*! react-hot-loader */ \"react-hot-loader\").enterModule;\n\n  enterModule && enterModule(module);\n})();\n\nvar jetpack = __webpack_require__(/*! fs-jetpack */ \"fs-jetpack\");\n\nconst APP_ROOT_DIR = jetpack.cwd(_electron.app.getAppPath());\nconst packageJson = APP_ROOT_DIR.read(\"package.json\", \"json\");\nconst apiUrl = 'http://localhost:3500';\nconst localDBname = 'coglite';\nconst cogliteDir = (0, path.normalize)(`${(0, _os.homedir)()}/.coglite/`);\nconst uploadDir = (0, path.normalize)(`${(0, _os.homedir)()}/.coglite/uploads/`); // Root is relative to where this file is when in the build folder)\n//const root = path.join(__dirname, \"../..\");\n\nconst root = path.join(_electron.app.getAppPath());\nconst portrange = 45032;\n\nfunction getPort(port = portrange) {\n  return new Promise((resolve, reject) => {\n    const server = net.createServer();\n    server.listen(port, err => {\n      server.once(\"close\", () => {\n        resolve(port);\n      });\n      server.close();\n    });\n    server.on(\"error\", err => {\n      getPort(port + 1).then(x => {\n        resolve(x);\n      });\n    });\n  });\n}\n\nconst urls = {\n  main: {\n    dev: \"http://localhost:3178/index.html\",\n    prod: `file://${__dirname}/../../build/index.html`\n  },\n  splash: {\n    dev: `file://${root}/src/server/splash-screen/splash-screen.html`,\n    prod: `file://${root}/build/server/splash-screen/splash-screen.html`\n  },\n  recover: {\n    dev: `file://${root}/src/server/recover-window/recover-window.html`,\n    prod: `file://${root}/build/server/recover-window/recover-window.html`\n  },\n  icon: __dirname + \"/../assets/images/icon.ico\"\n};\nconst isAsar = process.mainModule.filename.indexOf(\"app.asar\") !== -1;\nconst logsFolder = isAsar ? path.join(_electron.app.getPath(\"userData\"), \"logs\") : path.join(root, \"logs\");\nconst resourcesFolder = isAsar ? path.normalize(path.join(root, \"..\")) : root;\nmkdirp.sync(logsFolder);\nconst pythonServerPort = {\n  dev: Promise.resolve(8765),\n  prod: getPort()\n};\nconst customProtocolName = 'coglite';\nconst Constants = {\n  isAsar,\n  isDev: !isAsar,\n  root,\n  urls,\n  logsFolder,\n  resourcesFolder,\n  pythonServerPort,\n  version: packageJson.version,\n  customProtocolName\n};\nexports.Constants = Constants;\n;\n\n(function () {\n  var reactHotLoader = __webpack_require__(/*! react-hot-loader */ \"react-hot-loader\").default;\n\n  var leaveModule = __webpack_require__(/*! react-hot-loader */ \"react-hot-loader\").leaveModule;\n\n  if (!reactHotLoader) {\n    return;\n  }\n\n  reactHotLoader.register(APP_ROOT_DIR, \"APP_ROOT_DIR\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\constants.ts\");\n  reactHotLoader.register(packageJson, \"packageJson\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\constants.ts\");\n  reactHotLoader.register(apiUrl, \"apiUrl\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\constants.ts\");\n  reactHotLoader.register(localDBname, \"localDBname\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\constants.ts\");\n  reactHotLoader.register(cogliteDir, \"cogliteDir\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\constants.ts\");\n  reactHotLoader.register(uploadDir, \"uploadDir\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\constants.ts\");\n  reactHotLoader.register(root, \"root\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\constants.ts\");\n  reactHotLoader.register(portrange, \"portrange\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\constants.ts\");\n  reactHotLoader.register(getPort, \"getPort\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\constants.ts\");\n  reactHotLoader.register(urls, \"urls\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\constants.ts\");\n  reactHotLoader.register(isAsar, \"isAsar\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\constants.ts\");\n  reactHotLoader.register(logsFolder, \"logsFolder\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\constants.ts\");\n  reactHotLoader.register(resourcesFolder, \"resourcesFolder\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\constants.ts\");\n  reactHotLoader.register(pythonServerPort, \"pythonServerPort\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\constants.ts\");\n  reactHotLoader.register(customProtocolName, \"customProtocolName\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\constants.ts\");\n  reactHotLoader.register(Constants, \"Constants\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\constants.ts\");\n  leaveModule(module);\n})();\n\n;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../node_modules/webpack/buildin/module.js */ \"./node_modules/webpack/buildin/module.js\")(module)))\n\n//# sourceURL=webpack:///./src/desktop/constants.ts?");
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(module) {\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.MainWindow = void 0;\n\nvar _electron = __webpack_require__(/*! electron */ \"electron\");\n\nvar _constants = __webpack_require__(/*! ../constants */ \"./src/desktop/constants.ts\");\n\nvar _events = __webpack_require__(/*! events */ \"events\");\n\n(function () {\n  var enterModule = __webpack_require__(/*! react-hot-loader */ \"react-hot-loader\").enterModule;\n\n  enterModule && enterModule(module);\n})();\n\nconst devServerUrl = _constants.Constants.urls.main.dev;\nconst buildFileUrl = _constants.Constants.urls.main.prod;\n\nclass MainWindow extends _events.EventEmitter {\n  createWindow() {\n    const mainWindow = new _electron.BrowserWindow({\n      height: 1000,\n      icon: _constants.Constants.urls.icon,\n      width: 1600,\n      show: true,\n      webPreferences: {\n        webSecurity: false,\n        experimentalFeatures: true,\n        experimentalCanvasFeatures: true\n      }\n    });\n    const url = process.env.HOT ? devServerUrl : buildFileUrl;\n    mainWindow.loadURL(url);\n    return mainWindow;\n  }\n\n  __reactstandin__regenerateByEval(key, code) {\n    this[key] = eval(code);\n  }\n\n}\n\nexports.MainWindow = MainWindow;\n;\n\n(function () {\n  var reactHotLoader = __webpack_require__(/*! react-hot-loader */ \"react-hot-loader\").default;\n\n  var leaveModule = __webpack_require__(/*! react-hot-loader */ \"react-hot-loader\").leaveModule;\n\n  if (!reactHotLoader) {\n    return;\n  }\n\n  reactHotLoader.register(devServerUrl, \"devServerUrl\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\core\\\\main-window.ts\");\n  reactHotLoader.register(buildFileUrl, \"buildFileUrl\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\core\\\\main-window.ts\");\n  reactHotLoader.register(MainWindow, \"MainWindow\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\core\\\\main-window.ts\");\n  leaveModule(module);\n})();\n\n;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../../node_modules/webpack/buildin/module.js */ \"./node_modules/webpack/buildin/module.js\")(module)))\n\n//# sourceURL=webpack:///./src/desktop/core/main-window.ts?");
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(module) {\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.PrettyStream = void 0;\n\nvar _stream = __webpack_require__(/*! stream */ \"stream\");\n\nvar _util = __webpack_require__(/*! util */ \"util\");\n\n(function () {\n  var enterModule = __webpack_require__(/*! react-hot-loader */ \"react-hot-loader\").enterModule;\n\n  enterModule && enterModule(module);\n})();\n\nconst colors = {\n  bold: [1, 22],\n  italic: [3, 23],\n  underline: [4, 24],\n  inverse: [7, 27],\n  white: [37, 39],\n  grey: [90, 39],\n  black: [30, 39],\n  blue: [34, 39],\n  cyan: [36, 39],\n  green: [32, 39],\n  magenta: [35, 39],\n  red: [31, 39],\n  yellow: [33, 39]\n};\nconst defaultOptions = {\n  useColor: true\n};\nconst config = defaultOptions;\nconst levelFromName = {\n  trace: 10,\n  debug: 20,\n  info: 30,\n  warn: 40,\n  error: 50,\n  fatal: 60\n};\nconst colorFromLevel = {\n  10: \"grey\",\n  // TRACE\n  20: \"grey\",\n  // DEBUG\n  30: \"cyan\",\n  // INFO\n  40: \"magenta\",\n  // WARN\n  50: \"red\",\n  // ERROR\n  60: \"inverse\" // FATAL\n\n};\nlet nameFromLevel = {};\nlet upperNameFromLevel = {};\nlet upperPaddedNameFromLevel = {};\nObject.keys(levelFromName).forEach(name => {\n  let lvl = levelFromName[name];\n  nameFromLevel[lvl] = name;\n  upperNameFromLevel[lvl] = name.toUpperCase();\n  upperPaddedNameFromLevel[lvl] = (name.length === 4 ? \" \" : \"\") + name.toUpperCase();\n});\n\nfunction stylize(str, color = \"white\") {\n  if (!str) {\n    return \"\";\n  }\n\n  if (!config.useColor) {\n    return str;\n  }\n\n  let codes = colors[color];\n\n  if (codes) {\n    return \"\\x1B[\" + codes[0] + \"m\" + str + \"\\x1B[\" + codes[1] + \"m\";\n  }\n\n  return str;\n}\n\nfunction indent(s) {\n  return \"    \" + s.split(/\\r?\\n/).join(\"\\n    \");\n}\n\nfunction extractTime(rec) {\n  let time = typeof rec.time === \"object\" ? rec.time.toISOString() : rec.time;\n  return stylize(time.substr(11));\n}\n\nfunction extractLevel(rec) {\n  const level = upperPaddedNameFromLevel[rec.level] || \"LVL\" + rec.level;\n  return stylize(level, colorFromLevel[rec.level]);\n}\n\nfunction isSingleLineMsg(rec) {\n  return rec.msg.indexOf(\"\\n\") === -1;\n}\n\nfunction extractMsg(rec) {\n  return stylize(rec.msg, \"cyan\");\n}\n\nfunction extractError(rec) {\n  if (rec.err && rec.err.stack) {\n    return rec.err.stack;\n  }\n}\n\nfunction extractCustomDetails(rec) {\n  const skip = new Set([\"name\", \"hostname\", \"pid\", \"level\", \"component\", \"msg\", \"time\", \"v\", \"src\", \"err\", \"client_req\", \"client_res\", \"req\", \"res\"]);\n  const details = [];\n  const extras = {};\n\n  for (let key of Object.keys(rec)) {\n    if (skip.has(key)) {\n      continue;\n    }\n\n    let value = rec[key];\n\n    if (typeof value === \"undefined\") {\n      value = \"\";\n    }\n\n    let stringified = false;\n\n    if (typeof value !== \"string\") {\n      value = JSON.stringify(value, null, 2);\n      stringified = true;\n    }\n\n    if (value.indexOf(\"\\n\") !== -1 || value.length > 50) {\n      details.push(key + \": \" + value);\n    } else if (!stringified && (value.indexOf(\" \") !== -1 || value.length === 0)) {\n      extras[key] = JSON.stringify(value);\n    } else {\n      extras[key] = value;\n    }\n  }\n\n  return {\n    details: details,\n    extras: extras\n  };\n}\n\nfunction applyDetails(results, details, extras) {\n  if (!results) {\n    return;\n  }\n\n  for (let detail of results.details) {\n    details.push(indent(detail));\n  }\n\n  for (let key of Object.keys(results.extras)) {\n    extras.push(key + \"=\" + results.extras[key]);\n  }\n}\n\nclass PrettyStream extends _stream.Stream {\n  constructor(opts = {}) {\n    super();\n    let options = {};\n\n    if (opts) {\n      Object.keys(opts).forEach(key => {\n        options[key] = {\n          value: opts[key],\n          enumerable: true,\n          writable: true,\n          configurable: true\n        };\n      });\n    } // let config = Object.create(defaultOptions, options);\n\n\n    this.readable = true;\n    this.writable = true;\n  }\n\n  write(data) {\n    if (typeof data === \"string\") {\n      this.emit(\"data\", this.formatRecord(JSON.parse(data)));\n    } else if (typeof data === \"object\") {\n      this.emit(\"data\", this.formatRecord(data));\n    }\n\n    return true;\n  }\n\n  end() {\n    this.emit(\"end\");\n    return true;\n  }\n\n  formatRecord(rec) {\n    let details = [];\n    let extras = [];\n    const time = extractTime(rec);\n    const level = extractLevel(rec);\n    const component = rec.name;\n    let msg = isSingleLineMsg(rec) ? extractMsg(rec) : \"\";\n\n    if (!msg) {\n      details.push(indent(extractMsg(rec)));\n    }\n\n    let error = extractError(rec);\n\n    if (error) {\n      details.push(indent(error));\n    }\n\n    applyDetails(extractCustomDetails(rec), details, extras);\n    extras = stylize(extras.length ? \" (\" + extras.join(\", \") + \")\" : \"\", \"grey\");\n    details = stylize(details.length ? details.join(\"\\n    --\\n\") + \"\\n\" : \"\", \"grey\");\n    return (0, _util.format)(\"[%s] %s: %s: %s%s\\n%s\", time, level, component, msg, extras, details);\n  }\n\n  __reactstandin__regenerateByEval(key, code) {\n    this[key] = eval(code);\n  }\n\n}\n\nexports.PrettyStream = PrettyStream;\n;\n\n(function () {\n  var reactHotLoader = __webpack_require__(/*! react-hot-loader */ \"react-hot-loader\").default;\n\n  var leaveModule = __webpack_require__(/*! react-hot-loader */ \"react-hot-loader\").leaveModule;\n\n  if (!reactHotLoader) {\n    return;\n  }\n\n  reactHotLoader.register(colors, \"colors\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\logger\\\\pretty-stream.ts\");\n  reactHotLoader.register(defaultOptions, \"defaultOptions\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\logger\\\\pretty-stream.ts\");\n  reactHotLoader.register(config, \"config\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\logger\\\\pretty-stream.ts\");\n  reactHotLoader.register(levelFromName, \"levelFromName\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\logger\\\\pretty-stream.ts\");\n  reactHotLoader.register(colorFromLevel, \"colorFromLevel\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\logger\\\\pretty-stream.ts\");\n  reactHotLoader.register(nameFromLevel, \"nameFromLevel\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\logger\\\\pretty-stream.ts\");\n  reactHotLoader.register(upperNameFromLevel, \"upperNameFromLevel\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\logger\\\\pretty-stream.ts\");\n  reactHotLoader.register(upperPaddedNameFromLevel, \"upperPaddedNameFromLevel\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\logger\\\\pretty-stream.ts\");\n  reactHotLoader.register(stylize, \"stylize\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\logger\\\\pretty-stream.ts\");\n  reactHotLoader.register(indent, \"indent\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\logger\\\\pretty-stream.ts\");\n  reactHotLoader.register(extractTime, \"extractTime\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\logger\\\\pretty-stream.ts\");\n  reactHotLoader.register(extractLevel, \"extractLevel\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\logger\\\\pretty-stream.ts\");\n  reactHotLoader.register(isSingleLineMsg, \"isSingleLineMsg\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\logger\\\\pretty-stream.ts\");\n  reactHotLoader.register(extractMsg, \"extractMsg\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\logger\\\\pretty-stream.ts\");\n  reactHotLoader.register(extractError, \"extractError\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\logger\\\\pretty-stream.ts\");\n  reactHotLoader.register(extractCustomDetails, \"extractCustomDetails\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\logger\\\\pretty-stream.ts\");\n  reactHotLoader.register(applyDetails, \"applyDetails\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\logger\\\\pretty-stream.ts\");\n  reactHotLoader.register(PrettyStream, \"PrettyStream\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\logger\\\\pretty-stream.ts\");\n  leaveModule(module);\n})();\n\n;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../../node_modules/webpack/buildin/module.js */ \"./node_modules/webpack/buildin/module.js\")(module)))\n\n//# sourceURL=webpack:///./src/desktop/logger/pretty-stream.ts?");
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(module) {\n\nvar path = __webpack_require__(/*! path */ \"path\");\n\nvar _electron = __webpack_require__(/*! electron */ \"electron\");\n\n__webpack_require__(/*! reflect-metadata */ \"reflect-metadata\");\n\n__webpack_require__(/*! ../common/extensions */ \"./src/common/extensions/index.ts\");\n\nvar _constants = __webpack_require__(/*! ./constants */ \"./src/desktop/constants.ts\");\n\nvar _logger = __webpack_require__(/*! ./logger */ \"./src/desktop/logger/index.ts\");\n\nvar _startup = __webpack_require__(/*! ./startup */ \"./src/desktop/startup.ts\");\n\n(function () {\n  var enterModule = __webpack_require__(/*! react-hot-loader */ \"react-hot-loader\").enterModule;\n\n  enterModule && enterModule(module);\n})();\n\n_electron.app.setPath(\"userData\", path.join(_electron.app.getPath(\"appData\"), \"coglite\")); // 2. Setup extension functions\n\n\nvar mainhtml = _constants.Constants.urls.main;\nconsole.log(mainhtml);\n(0, _startup.startCogliteDesktop)().catch(e => {\n  _logger.logger.error(\"Error starting Coglite Desktop\", e);\n});\n;\n\n(function () {\n  var reactHotLoader = __webpack_require__(/*! react-hot-loader */ \"react-hot-loader\").default;\n\n  var leaveModule = __webpack_require__(/*! react-hot-loader */ \"react-hot-loader\").leaveModule;\n\n  if (!reactHotLoader) {\n    return;\n  }\n\n  reactHotLoader.register(mainhtml, \"mainhtml\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\main.ts\");\n  leaveModule(module);\n})();\n\n;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../node_modules/webpack/buildin/module.js */ \"./node_modules/webpack/buildin/module.js\")(module)))\n\n//# sourceURL=webpack:///./src/desktop/main.ts?");
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(module) {\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.startCogliteDesktop = startCogliteDesktop;\n\nvar _electron = __webpack_require__(/*! electron */ \"electron\");\n\nvar _core = __webpack_require__(/*! ./core */ \"./src/desktop/core/index.ts\");\n\nvar _pythonProcess = __webpack_require__(/*! ./python-process */ \"./src/desktop/python-process/index.ts\");\n\n(function () {\n  var enterModule = __webpack_require__(/*! react-hot-loader */ \"react-hot-loader\").enterModule;\n\n  enterModule && enterModule(module);\n})();\n\nconst pythonServer = new _pythonProcess.PythonRpcServerProcess();\npythonServer.start();\nvar cogliteApp;\n\nfunction registerAuthProtocol() {\n  _electron.protocol.registerStringProtocol(\"urn\", (request, callback) => {\n    callback();\n  });\n}\n\nasync function startApplication(cogliteApp) {\n  registerAuthProtocol();\n  cogliteApp.registerCoreServices().then(() => {\n    cogliteApp.start();\n  });\n}\n\nasync function startCogliteDesktop() {\n  //localStorage.load();\n  const cogliteApp = new _core.CogliteDesktopApp();\n\n  if (_electron.app.isReady()) {\n    startApplication(cogliteApp);\n  } else {\n    _electron.app.on(\"ready\", async () => {\n      startApplication(cogliteApp);\n    });\n  }\n\n  (0, _core.listenToSelectCertifcateEvent)();\n  process.on(\"exit\", () => {\n    cogliteApp.quit();\n    pythonServer.stop();\n  });\n  process.on(\"SIGINT\", () => {\n    process.exit(-1);\n  });\n  process.on(\"SIGINT\", () => {\n    process.exit(-2);\n  });\n}\n\n;\n\n(function () {\n  var reactHotLoader = __webpack_require__(/*! react-hot-loader */ \"react-hot-loader\").default;\n\n  var leaveModule = __webpack_require__(/*! react-hot-loader */ \"react-hot-loader\").leaveModule;\n\n  if (!reactHotLoader) {\n    return;\n  }\n\n  reactHotLoader.register(pythonServer, \"pythonServer\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\startup.ts\");\n  reactHotLoader.register(cogliteApp, \"cogliteApp\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\startup.ts\");\n  reactHotLoader.register(registerAuthProtocol, \"registerAuthProtocol\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\startup.ts\");\n  reactHotLoader.register(startApplication, \"startApplication\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\startup.ts\");\n  reactHotLoader.register(startCogliteDesktop, \"startCogliteDesktop\", \"C:\\\\Users\\\\Jeremy\\\\Desktop\\\\Coglite\\\\@CogliteDesktop\\\\src\\\\desktop\\\\startup.ts\");\n  leaveModule(module);\n})();\n\n;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../node_modules/webpack/buildin/module.js */ \"./node_modules/webpack/buildin/module.js\")(module)))\n\n//# sourceURL=webpack:///./src/desktop/startup.ts?");
